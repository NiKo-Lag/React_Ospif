    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.ok) {
                ...
                // Obtener la sesión para determinar el rol y la redirección adecuada
                ...
                if (session && session.user) {
                    ...
                    router.push(callbackUrl || '/'); // Fallback si no se puede obtener la sesión
                }
            }
        } catch (error) {
            ...
            <div className="min-h-screen flex flex-col md:flex-row">
                ...
                <div className="relative hidden lg:flex w-full md:w-1/2 items-center justify-center p-12 bg-gradient-to-br from-gray-800 to-gray-900 text-white overflow-hidden">
                    ...
                    <div className="relative z-10 text-center space-y-4">
                        <h1 className="text-4xl font-bold tracking-tight animate-fade-in-up max-w-xl" style={{ animationDelay: '300ms' }}>
                            Portal de Gestión OSPIF
                        </h1>
                        <p className="text-gray-300 animate-fade-in-up" style={{ animationDelay: '500ms' }}>Obra Social del Personal de la Industria del Fósforo</p>
                    </div>
                    <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-600 to-blue-500 rounded-full mix-blend-lighten filter blur-3xl opacity-20 animate-blob"></div>
                ...
                <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-gray-50">
                    <div className="max-w-md w-full space-y-8">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">Ingresá tus credenciales para acceder al portal.</p>
                        </div>
